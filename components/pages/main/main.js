	...
	render: function() {
		return(
			<div id="main">
				...
				<div id="main-img1" data-wow-delay="0.6s" className="wow animate__animated animate__fadeInUp"  width="100%"></div>
				...
				<div id="main-img3" className="offset wow animate__animated animate__bounceInLeft"  width="100%"></div>
